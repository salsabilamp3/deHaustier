...
int main(int argc, char *argv[]) {
	...
	do{
		...
		printf("%10.c%c%40.c2. Ruang Periksa ",empty,186,empty);printf("%43.c%c\n",empty,186);
		printf("%10.c%c%40.c3. Proses Antrian   ",empty,186,empty);printf("%40.c%c\n",empty,186);
		printf("%10.c%c%40.c4. List Antrian      ",empty,186,empty);printf("%39.c%c\n",empty,186);
		printf("%10.c%c%40.c5. Cari Antrian      ",empty,186,empty);printf("%39.c%c\n",empty,186);
		printf("%10.c%c%40.c6. Tentang         ",empty,186,empty);printf("%41.c%c\n",empty,186);
		printf("%10.c%c%40.c7. Keluar         ",empty,186,empty);printf("%42.c%c\n",empty,186);
		...
		if(pilihanMenu == '2'){
			system("cls");
			printLogo();
			printf("\n%10.c%c%21.c __                  __      __   ___  __          __     ",empty,186,empty);printf("%21.c%c\n",empty,186);
			printf("%10.c%c%21.c|__) |  |  /%c  |%c | / _`    |__) |__  |__) | |__/ /__`  /%c  ",empty,186,empty,92,92,92);printf("%19.c%c\n",empty,186);
		...
		if(pilihanMenu == '5'){
			system("cls");
			printLogo();
			printf("\n%10.c%c%27.c __        __                 ___  __                   ",empty,186,empty);printf("%17.c%c\n",empty,186);
			printf("%10.c%c%27.c/  `  /%c  |__) |     /%c  |%c |  |  |__) |  /%c  |%c | ",empty,186,empty,92,92,92,92,92);printf("%22.c%c\n",empty,186);
			printf("%10.c%c%27.c%c__, /~~%c |  %c |    /~~%c | %c|  |  |  %c | /~~%c | %c| ",empty,186,empty,92,92,92,92,92,92,92,92);printf("%22.c%c\n",empty,186);
			printf("%10.c%c",empty,186);for(panjang=0; panjang<100; panjang++){printf("%c",empty);}printf("%c\n",186);                                                          
		    printf("%10.c%c",empty,200);for(panjang=0; panjang<100; panjang++){printf("%c",205);}printf("%c\n",188);   
			cariAntrian(Q);
			system("pause");
